                  ...
                  <div className="space-y-6">
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <a href="mailto:info@ruridenthealth.co.ke" className="text-blue-600 hover:text-blue-700 font-medium">
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <a href="tel:+254703416433" className="text-green-600 hover:text-green-700 font-medium">
                          +254 703 416 433
                        </a>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-4">
                      <div className="w-12 h-12 bg-purple-100 rounded-lg flex items-center justify-center">
                        <HiOfficeBuilding className="h-6 w-6 text-purple-600" />
                      </div>
                      <div>
                        <h4 className="text-lg font-semibold text-gray-900">Office Address</h4>
                        <p className="text-gray-600">
                          Mepalux Plaza, 3rd Floor<br />
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center justify-center w-full bg-green-400 text-white py-3 px-6 rounded-lg font-medium hover:bg-green-500 transition-colors"
                    >
                    ...
                    <a
                      href="mailto:info@ruridenthealth.co.ke"
                      className="flex items-center justify-center w-full bg-blue-500 text-white py-3 px-6 rounded-lg font-medium hover:bg-blue-600 transition-colors"
                    >
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center justify-center w-full bg-purple-500 text-white py-3 px-6 rounded-lg font-medium hover:bg-purple-600 transition-colors"
                    >
