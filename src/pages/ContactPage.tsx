  ...
  return (
    <div className="min-h-screen bg-gray-50 pt-20">
      ...
      <div className="container-max py-12">
        {/* Contact Methods Grid - Mobile Optimized */}
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-6 mb-12">
          {/* Phone */}
          <div className="bg-white rounded-xl shadow-lg p-3 sm:p-4 md:p-6 text-center hover:shadow-xl transition-all duration-300 border border-gray-100">
            <div className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 bg-gradient-to-r from-green-500 to-green-600 rounded-full flex items-center justify-center mx-auto mb-3 md:mb-4">
              <HiPhone className="h-6 w-6 sm:h-7 sm:w-7 md:h-8 md:w-8 text-white" />
            </div>
            <h3 className="text-sm sm:text-base md:text-lg font-semibold text-gray-900 mb-2">Phone</h3>
            <p className="text-xs sm:text-sm md:text-base text-gray-600 mb-3 hidden sm:block">Call us for immediate assistance</p>
            <a 
              href="tel:+254703416433" 
              className="inline-block bg-green-500 text-white px-2 py-1.5 sm:px-3 sm:py-2 md:px-4 md:py-2 rounded-lg text-xs sm:text-sm md:text-base font-medium hover:bg-green-600 transition-colors"
            >
              <span className="hidden sm:inline">+254 703 416 433</span>
          ...
          {/* Email */}
          <div className="bg-white rounded-xl shadow-lg p-3 sm:p-4 md:p-6 text-center hover:shadow-xl transition-all duration-300 border border-gray-100">
            <div className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 bg-gradient-to-r from-blue-500 to-blue-600 rounded-full flex items-center justify-center mx-auto mb-3 md:mb-4">
              <HiMail className="h-6 w-6 sm:h-7 sm:w-7 md:h-8 md:w-8 text-white" />
            </div>
            <h3 className="text-sm sm:text-base md:text-lg font-semibold text-gray-900 mb-2">Email</h3>
            <p className="text-xs sm:text-sm md:text-base text-gray-600 mb-3 hidden sm:block">Send us your inquiries</p>
            <a 
              href="mailto:info@ruridenthealth.co.ke" 
              className="inline-block bg-blue-500 text-white px-2 py-1.5 sm:px-3 sm:py-2 md:px-4 md:py-2 rounded-lg text-xs sm:text-sm md:text-base font-medium hover:bg-blue-600 transition-colors"
            >
              Email Us
            </a>
          </div>
          ...
          {/* WhatsApp */}
          <div className="bg-white rounded-xl shadow-lg p-3 sm:p-4 md:p-6 text-center hover:shadow-xl transition-all duration-300 border border-gray-100">
            <div className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 bg-gradient-to-r from-green-400 to-green-500 rounded-full flex items-center justify-center mx-auto mb-3 md:mb-4">
            ...
            <h3 className="text-sm sm:text-base md:text-lg font-semibold text-gray-900 mb-2">WhatsApp</h3>
            <p className="text-xs sm:text-sm md:text-base text-gray-600 mb-3 hidden sm:block">Chat with us instantly</p>
            <a 
              href="https://wa.me/254703416433" 
              target="_blank" 
              rel="noopener noreferrer"
              className="inline-block bg-green-400 text-white px-2 py-1.5 sm:px-3 sm:py-2 md:px-4 md:py-2 rounded-lg text-xs sm:text-sm md:text-base font-medium hover:bg-green-500 transition-colors"
            >
          ...
          {/* Visit Us */}
          <div className="bg-white rounded-xl shadow-lg p-3 sm:p-4 md:p-6 text-center hover:shadow-xl transition-all duration-300 border border-gray-100">
            <div className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 bg-gradient-to-r from-purple-500 to-purple-600 rounded-full flex items-center justify-center mx-auto mb-3 md:mb-4">
              <HiLocationMarker className="h-6 w-6 sm:h-7 sm:w-7 md:h-8 md:w-8 text-white" />
            </div>
            <h3 className="text-sm sm:text-base md:text-lg font-semibold text-gray-900 mb-2">Visit Us</h3>
            <p className="text-xs sm:text-sm md:text-base text-gray-600 mb-3 hidden sm:block">Mepalux Plaza, River Road</p>
            <a 
              href="https://maps.google.com/?q=Mepalux+Plaza+River+Road+Nairobi+Kenya" 
              target="_blank" 
              rel="noopener noreferrer"
              className="inline-block bg-purple-500 text-white px-2 py-1.5 sm:px-3 sm:py-2 md:px-4 md:py-2 rounded-lg text-xs sm:text-sm md:text-base font-medium hover:bg-purple-600 transition-colors"
            >
