  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container-max py-12 md:py-16">
        ...
        <div className="bg-gradient-to-r from-orange-500 to-red-500 text-white rounded-2xl p-12 mb-16">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold mb-4">Why Choose Rurident Health Supplies?</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              <div className="w-20 h-20 bg-white/20 rounded-full flex items-center justify-center mx-auto mb-4">
                <HiUserGroup className="h-10 w-10 text-white" />
              </div>
              <h3 className="text-2xl font-bold mb-2">2000+</h3>
              <p className="text-orange-100">Satisfied Clients Across East Africa</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-orange-100">Premium Dental Equipment Products</p>
            </div>
            
            <div className="text-center">
              <div className="w-20 h-20 bg-white/20 rounded-full flex items-center justify-center mx-auto mb-4">
                <HiTruck className="h-10 w-10 text-white" />
              </div>
              <h3 className="text-2xl font-bold mb-2">2-4 Hours</h3>
              <p className="text-orange-100">Same-Day Delivery in Nairobi CBD</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-orange-100">Excellence in Dental Equipment Supply</p>
            </div>
          </div>
        </div>
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow">
              <h3 className="text-lg font-bold text-gray-900 mb-3">Dental Chairs & Units</h3>
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow">
              <h3 className="text-lg font-bold text-gray-900 mb-3">Imaging Equipment</h3>
              <ul className="text-sm text-gray-600 space-y-1">
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow">
              <h3 className="text-lg font-bold text-gray-900 mb-3">Surgical Instruments</h3>
              <ul className="text-sm text-gray-600 space-y-1">
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow">
              <h3 className="text-lg font-bold text-gray-900 mb-3">Student Supplies</h3>
              <ul className="text-sm text-gray-600 space-y-1">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
          ...
          <div className="bg-gradient-to-br from-orange-50 to-orange-100 rounded-xl shadow-lg p-8 border border-orange-200">
        ...
        {/* Call to Action */}
        <div className="text-center bg-gradient-to-r from-orange-500 to-red-500 text-white rounded-2xl p-12">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a 
              href="/products" 
              className="border-2 border-white text-white hover:bg-white hover:text-orange-600 px-8 py-4 rounded-lg font-bold text-lg transition-colors"
            >
              Browse Our Products
            </a>
          </div>
