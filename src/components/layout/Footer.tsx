        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center space-x-2 mb-3">
              ...
              <div>
                <h3 className="text-lg font-bold">Rurident Health Supplies</h3>
            ...
            <div className="space-y-2">
              <div className="flex items-start space-x-2">
                <HiLocationMarker className="text-primary-400 mt-0.5 h-4 w-4 flex-shrink-0" />
                <div className="text-sm">
                  <p className="text-gray-300">Mepalux Plaza Nairobi, River Road, 3rd Floor</p>
                  <p className="text-gray-300">Opp. Bata Mini Price, Suite 304</p>
                </div>
              </div>

              <div className="flex items-center space-x-2">
                <HiPhone className="text-primary-400 h-4 w-4 flex-shrink-0" />
              ...
              <div className="flex items-center space-x-2">
                <HiClock className="text-primary-400 h-4 w-4 flex-shrink-0" />
                <div className="text-sm">
