...
export function CategorySections() {
  const categories = [
    {
      ...
      subsections: [
        { name: 'Crown and Bridge', path: '/products?category=crown-bridge', icon: '👑' },
        ...
        { name: 'Partial Dentures (Cobalt Chrome)', path: '/products?category=partial-dentures', icon: '🔩' },
        { name: 'Lab Consumables', path: '/products?category=lab-consumables', icon: '🧪' }
      ]
    },
    {
      id: 'dental-chairs',
  ...
  return (
    <div className="bg-white py-8 sm:py-12 relative category-section">
